...
namespace HangManStarterKit
{
    class HangmanGame
    {
        ...
        public string word;
        public int tries = 0; //++ on guesses
        public List<char> guessedLetters = new List<char>();//guessed letters
        public List<char> foundLetters = new List<char>();//letters guessed in word
        List<string> wordBank = new List<string>{"fish","apple","tree", "dog", "rides", "scrambled" };//random word from word bank
        Player guesser;
